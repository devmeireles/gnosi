...
const { validateCatalogue, validateCatalogueCategory, validateCatalogueObjective } = require('../middlewares/validator/CatalogueValidator');

routes.get('/catalogue', CatalogueController.index);
routes.post('/catalogue/:id/language', CatalogueController.addLanguage);
routes.post('/catalogue/:id/objective', validateCatalogueObjective, CatalogueController.addObjective);
